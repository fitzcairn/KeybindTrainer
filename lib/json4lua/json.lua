...
--
--
--   NOTE: Code modified by Fitzcairn of Cenarion Circle to work in the WoW lua
--   environment.  Additionally, this modified code will be released as part
--   of a GPL'd project.  For further information on licence issues, see:
--
...
-- Module declaration
-----------------------------------------------------------------------------
-- Fitz: Changed to use base table instead of module() statement.
-- This is required to function in the WoW lua environment. 
json = {}
...
do
	...
	-- token tables (mostly, the boolean valumodule("json")e 'true' is used to indicate termination
	-- of a token sequence)
...
--[[	
	...
	function json.decode (js_string)
